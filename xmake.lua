-- Mod Options
local mod_name = "Offhand" -- Replace with the name of your mod
...
package("Runtime-Importer")
    set_kind("binary")
    set_homepage("https://github.com/FrederoxDev/Runtime-Importer")
    ...
    on_load(function (package)
        ...
        http.download("https://api.github.com/repos/FrederoxDev/Runtime-Importer/releases/latest", releases_file)
        ...
        if should_reinstall then
            ...
            local url = "https://github.com/FrederoxDev/Runtime-Importer/releases/latest/download/Runtime-Importer.zip"
